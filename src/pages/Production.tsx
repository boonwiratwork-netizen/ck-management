...
export default function ProductionPage({ productionData, skus, bomHeaders, stockBalances, bomLines, smStockBalances, menuBomLines, menus }: ProductionPageProps) {
  const {
  ...
  return (
    <div className="space-y-4">
      ...
      <Tabs defaultValue="plan">
        <TabsList>
          <TabsTrigger value="plan">แผนการผลิต</TabsTrigger>
          <TabsTrigger value="records">บันทึกการผลิต</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="plan">
          <ProductionPlanTab
            ...
            smStockBalances={smStockBalances}
            menuBomLines={menuBomLines}
            menus={menus}
            getOutputPerBatch={getOutputPerBatch}
          />
        </TabsContent>

        {/* TAB 2 — Production Records (existing flow, unchanged) */}
